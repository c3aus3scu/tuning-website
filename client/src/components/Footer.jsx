...
export default function Footer() {
  return (
    <footer className="bg-white mt-20 pt-10 pb-6 px-6 border-t border-gray-200 text-center md:text-left">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-start gap-10 text-sm text-gray-700">
        ...
        <div className="w-full md:w-1/2 text-center md:text-right">
          ...
          <div className="flex justify-center md:justify-end gap-6 text-xl text-gray-700">
